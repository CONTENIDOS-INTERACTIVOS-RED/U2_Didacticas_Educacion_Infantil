        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 El arte y la expresión corporal en la educación inicial son esenciales para el desarrollo integral de los niños. El arte permite expresar emociones, fomentar la creatividad y fortalecer habilidades sociales. Se destacan lenguajes como la música, la expresión plástica y el juego dramático. La expresión corporal, por su parte, facilita la comunicación y exploración del entorno. Además, la educación inicial debe integrar experiencias artísticas variadas, promoviendo la sensibilidad estética y el pensamiento crítico. La interacción con el arte enriquece la identidad y el aprendizaje infantil.
